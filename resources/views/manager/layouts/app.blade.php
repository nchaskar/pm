            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            <a href="{{ url('manager/dashboard') }}" class="waves-effect">
                                <i class="bx bx-home-circle"></i><span key="t-chat">Dashboard</span>
                            </a>
                        </li>

                        <li><a href="{{ url('manager/project/show') }}" class="waves-effect">
                                <i class="bx bx-home-circle"></i><span key="t-chat">Projects</span>
                            </a>
                        </li>

                        <li><a href="{{ url('manager/tasks/show') }}" class="waves-effect">
