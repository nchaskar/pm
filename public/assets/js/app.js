!(function (n) {
    ...
    n("#side-menu").metisMenu(),
        ...
        window.sessionStorage && ((e = sessionStorage.getItem("is_visited")) ? (n(".right-bar input:checkbox").prop("checked", !1), n("#" + e).prop("checked", !0), l(e)) : sessionStorage.setItem("is_visited", "light-mode-switch")),
